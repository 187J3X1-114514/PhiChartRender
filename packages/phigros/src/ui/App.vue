<template>
    ...
    -->
    <mdui-top-app-bar :class="{ 'tauri': ON_TAURI, 'windows': ON_WINDOWS, 'flex-display': true, 'transparent': true }"
        ref="topAppBar" variant="hide" id="top-app-bar" style="display: flex" class="left-all top-app-bar">
    ...
    <mdui-navigation-rail :class="{ 'tauri': ON_TAURI, 'windows': ON_WINDOWS, 'transparent': true }"
        ref="navigationRail" value="welcome" id="navigation-rail">
