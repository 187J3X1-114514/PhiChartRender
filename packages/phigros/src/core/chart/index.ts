    ...
    static async from(rawChart: any, music?: Audio, _chartInfo?: any, _chartLineTexture = []) {
        ...
        chart.judgelines.forEach((judgeline) => {
            judgeline.eventLayers.forEach((eventLayer) => {
                ...
                eventLayer.moveXAnim.events = arrangeLineEvents(eventLayer.moveXAnim.events);
                eventLayer.moveYAnim.events = arrangeLineEvents(eventLayer.moveYAnim.events);
                eventLayer.rotateAnim.events = arrangeLineEvents(eventLayer.rotateAnim.events);
                eventLayer.alphaAnim.events = arrangeLineEvents(eventLayer.alphaAnim.events);
            });
