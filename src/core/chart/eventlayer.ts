...
export default class EventLayer {
    ...
    calcTime(currentTime: number) {
        this._posX = this.valueCalculator(this.moveX, currentTime, this._posX);
        this._posY = this.valueCalculator(this.moveY, currentTime, this._posY);
        this._alpha = this.valueCalculator(this.alpha, currentTime, this._alpha);
        this._rotate = this.valueCalculator(this.rotate, currentTime, this._rotate);
