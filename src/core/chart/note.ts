...
export default class Note {
    ...
    public hitsound: WAudio | string | null;
    ...
    createSprite(texture: PhiAssets, zipFiles: ResourceManger, multiHL = true, _debug = false) {
        ...
        if (this.hitsound) {
            this.hitsound = (zipFiles.get(this.hitsound as string) as WAudio)!;
        }
